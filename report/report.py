...
final = "</div></body></html>"
# with open('./report/style.css', 'r') as file:
...
initial = "<!DOCTYPE html><html><head><meta charset = 'utf-8'>\
            <title class='title'>Samrachana-Araniko | Structure Analysis Report</title>" + \
                joinThings('link',"rel='stylesheet' href='"+RP('report')+"/style.css'",'')+\
...
def generateReport2d(mainDf, frameData, axialForceData, shearForceData, bendingMomentData, zoomFactorActions, slopeData, axialDisplacementData, shearDisplacementData, zoomFactorResponses, motionData, zoomFactorMotion, units=['1N','1m','C'], precision=3, author='Samrachana Araniko',organization='The Coding Company',address='tcc.com',fileName='./'):
