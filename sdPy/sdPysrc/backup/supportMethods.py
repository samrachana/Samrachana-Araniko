...
from sdPy.functionDefinitions import apply, unit
...
def rollerPlotData(location,scale=1,normal=array([0,0,1])):
    ...
    basic = vstack((xArrow,yArrow,zArrow,pt,pt+0.05*scale*nptx,npt,pt+0.05*scale*npt120,pt,pt+0.05*scale*npt240,npt,pt))
