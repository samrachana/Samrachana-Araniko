...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.reactionTable = QTableWidget(self.responseTab)
        if (self.reactionTable.columnCount() < 4):
            self.reactionTable.setColumnCount(4)
        __qtablewidgetitem = QTableWidgetItem()
        self.reactionTable.setHorizontalHeaderItem(0, __qtablewidgetitem)
        __qtablewidgetitem1 = QTableWidgetItem()
        self.reactionTable.setHorizontalHeaderItem(1, __qtablewidgetitem1)
        __qtablewidgetitem2 = QTableWidgetItem()
        self.reactionTable.setHorizontalHeaderItem(2, __qtablewidgetitem2)
        __qtablewidgetitem3 = QTableWidgetItem()
        self.reactionTable.setHorizontalHeaderItem(3, __qtablewidgetitem3)
        ...
        self.gridLayout_2.addWidget(self.reactionTable, 0, 0, 1, 1)
        ...
        if (self.forcesTable.columnCount() < 5):
            self.forcesTable.setColumnCount(5)
        __qtablewidgetitem4 = QTableWidgetItem()
        self.forcesTable.setHorizontalHeaderItem(0, __qtablewidgetitem4)
        __qtablewidgetitem5 = QTableWidgetItem()
        self.forcesTable.setHorizontalHeaderItem(1, __qtablewidgetitem5)
        __qtablewidgetitem6 = QTableWidgetItem()
        self.forcesTable.setHorizontalHeaderItem(2, __qtablewidgetitem6)
        __qtablewidgetitem7 = QTableWidgetItem()
        self.forcesTable.setHorizontalHeaderItem(3, __qtablewidgetitem7)
        __qtablewidgetitem8 = QTableWidgetItem()
        self.forcesTable.setHorizontalHeaderItem(4, __qtablewidgetitem8)
        ...
        self.displacementTable = QTableWidget(self.tab)
        if (self.displacementTable.columnCount() < 6):
            self.displacementTable.setColumnCount(6)
        __qtablewidgetitem9 = QTableWidgetItem()
        self.displacementTable.setHorizontalHeaderItem(0, __qtablewidgetitem9)
        __qtablewidgetitem10 = QTableWidgetItem()
        self.displacementTable.setHorizontalHeaderItem(1, __qtablewidgetitem10)
        __qtablewidgetitem11 = QTableWidgetItem()
        self.displacementTable.setHorizontalHeaderItem(2, __qtablewidgetitem11)
        __qtablewidgetitem12 = QTableWidgetItem()
        self.displacementTable.setHorizontalHeaderItem(3, __qtablewidgetitem12)
        __qtablewidgetitem13 = QTableWidgetItem()
        self.displacementTable.setHorizontalHeaderItem(4, __qtablewidgetitem13)
        __qtablewidgetitem14 = QTableWidgetItem()
        self.displacementTable.setHorizontalHeaderItem(5, __qtablewidgetitem14)
        ...
        self.gridLayout.addWidget(self.displacementTable, 0, 0, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", u"Results from Structure Analysis", None))
        ___qtablewidgetitem = self.reactionTable.horizontalHeaderItem(0)
        ___qtablewidgetitem.setText(QCoreApplication.translate("MainWindow", u"Node", None));
        ___qtablewidgetitem1 = self.reactionTable.horizontalHeaderItem(1)
        ___qtablewidgetitem1.setText(QCoreApplication.translate("MainWindow", u"Fx", None));
        ___qtablewidgetitem2 = self.reactionTable.horizontalHeaderItem(2)
        ___qtablewidgetitem2.setText(QCoreApplication.translate("MainWindow", u"Fy", None));
        ___qtablewidgetitem3 = self.reactionTable.horizontalHeaderItem(3)
        ___qtablewidgetitem3.setText(QCoreApplication.translate("MainWindow", u"M", None));
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.responseTab), QCoreApplication.translate("MainWindow", u"Reactions", None))
        ___qtablewidgetitem4 = self.forcesTable.horizontalHeaderItem(0)
        ___qtablewidgetitem4.setText(QCoreApplication.translate("MainWindow", u"Member", None));
        ___qtablewidgetitem5 = self.forcesTable.horizontalHeaderItem(1)
        ___qtablewidgetitem5.setText(QCoreApplication.translate("MainWindow", u"Node", None));
        ___qtablewidgetitem6 = self.forcesTable.horizontalHeaderItem(2)
        ___qtablewidgetitem6.setText(QCoreApplication.translate("MainWindow", u"Axial Force", None));
        ___qtablewidgetitem7 = self.forcesTable.horizontalHeaderItem(3)
        ___qtablewidgetitem7.setText(QCoreApplication.translate("MainWindow", u"Shear Force", None));
        ___qtablewidgetitem8 = self.forcesTable.horizontalHeaderItem(4)
        ___qtablewidgetitem8.setText(QCoreApplication.translate("MainWindow", u"Bending Moment", None));
        ...
        ___qtablewidgetitem9 = self.displacementTable.horizontalHeaderItem(0)
        ___qtablewidgetitem9.setText(QCoreApplication.translate("MainWindow", u"Node", None));
        ___qtablewidgetitem10 = self.displacementTable.horizontalHeaderItem(1)
        ___qtablewidgetitem10.setText(QCoreApplication.translate("MainWindow", u"x", None));
        ___qtablewidgetitem11 = self.displacementTable.horizontalHeaderItem(2)
        ___qtablewidgetitem11.setText(QCoreApplication.translate("MainWindow", u"y", None));
        ___qtablewidgetitem12 = self.displacementTable.horizontalHeaderItem(3)
        ___qtablewidgetitem12.setText(QCoreApplication.translate("MainWindow", u"dx", None));
        ___qtablewidgetitem13 = self.displacementTable.horizontalHeaderItem(4)
        ___qtablewidgetitem13.setText(QCoreApplication.translate("MainWindow", u"dy", None));
        ___qtablewidgetitem14 = self.displacementTable.horizontalHeaderItem(5)
        ___qtablewidgetitem14.setText(QCoreApplication.translate("MainWindow", u"slope", None));
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), QCoreApplication.translate("MainWindow", u"Nodal Displacements", None))
    # retranslateUi
