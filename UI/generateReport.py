...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.author.setText(QCoreApplication.translate("Dialog", u"John Doe", None))
        self.label_2.setText(QCoreApplication.translate("Dialog", u"Organization", None))
        self.organization.setText(QCoreApplication.translate("Dialog", u"Samrachana Araniko", None))
